...
function setup() {
  ...
  */
  ...
  artist.class('artInfo');

  //OLD version
  //URL: https://shrouded-woodland-95521.herokuapp.com. 
  //There's a play and pause button for the sound and some animation, though it mostly runs in a p5.js loop. 
